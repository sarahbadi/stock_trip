...
Public Class CopCrystalReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wind_stock.CopCrystalReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCopCrystalReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CopCrystalReport = New CopCrystalReport
        rpt.Site = Me.Site
        Return rpt
    End Function
