...
Public Class CrystalRepest
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wind_stock.CrystalRepest.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalRepest
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalRepest = New CrystalRepest
        rpt.Site = Me.Site
        Return rpt
    End Function
