...
Public Class Form_Isu
    ...
    Private Sub ButtonX1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX1.Click
        If Me.TextBox6.Text.ToString <> "" Then
            ...
            If ft = False Then
                ...
                End If
                '============================
                Dim s5 As String = "insert into IsuMain(no_s,date_s,j_s,total,u_name,tvg,dep_m,dep_mt,dep_nom,name_stock,name1_stock,no_kshf) values (@x1,@x2,@x3,@x4,@x5,@x6,@x7,@x8,@x9,@x10,@x11,@x12)"
                ...
                cm5.Parameters.Add((New SqlParameter("@x12", ssf_t)))
                Try
                    cm5.ExecuteNonQuery()
                    dsIsuM.Clear()
            ...
            Else
                ...
                Try
                    ...
                    cm1.ExecuteNonQuery()
                    '===============================smove_no_s==================
                    Dim sx As String = "insert into tran_IRT(no_c,quntity,price,tr_type,n_rs,date_i,count1,no_kshf) values (@x1,@x2,@x3,@x4,@x5,@x6,@x7,@x8)"
    ...
    Sub total_inf_new()
        ...
        If (Me.TextBox6.Text.ToString) <> " " Then
            ...
            If Im_tadel_s = "جديد" And (sefa = "امين مخزن" Or sefa = "موظف") Then
                ...
                TextBox6.Text = getNewNo(Me.dtYear.Value.Year, ssf_t, "GetNewNoIsuMain")
    ...
    Sub total_inf_tadel()
        ...
        If (Me.TextBox6.Text.ToString) <> " " Then
            ...
            Dim s11 As String = "SELECT * FROM IsuMain  WHERE no_s=@x1 and no_kshf =" & ssf_t & " "
            Dim cm As New SqlCommand(s11, cn)
            cm.Parameters.Add(New SqlParameter("@x1", TextBox6.Text))
            Try
                Dim r As SqlDataReader = cm.ExecuteReader
