...
Public Class CrystalRepmoves
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Wind_stock.CrystalRepmoves.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrystalRepmoves
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrystalRepmoves = New CrystalRepmoves
        rpt.Site = Me.Site
        Return rpt
    End Function
