...
Public Class F_Talif
    ...
    Sub smove_no_i()
        ...
        cm.Parameters.Add(New SqlParameter("@x1", Me.TextBox4.Text))
    ...
    Sub update_action_transrf()
        ...
        cm1.Parameters.Add(New SqlParameter("@x4", Me.TextBox4.Text))
    ...
    Sub But_action_user()
        ...
        cm.Parameters.Add(New SqlParameter("@x3", TextBox4.Text))
    ...
    Private Sub TextBoxX2_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
    ...
    Private Sub TextBoxX2_Leave(ByVal sender As Object, ByVal e As System.EventArgs)
    ...
    Private Sub ListView1_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ListView1.Click
        ...
        For Each litem In ListView1.SelectedItems
            Me.TextBox4.Text = litem.SubItems(0).Text
    ...
    Private Sub ButtonX1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ButtonX1.Click
        ...
        cm.Parameters.Add(New SqlParameter("@x1", TextBox1.Text))
        cm.Parameters.Add(New SqlParameter("@x2", TextBox4.Text))
    ...
    Sub stouck()
        If Me.TextBox4.Text <> "" Then
            ...
            Dim cm1 As New SqlCommand(s1, cn)
            cm1.Parameters.Add(New SqlParameter("@x1", TextBox4.Text))
