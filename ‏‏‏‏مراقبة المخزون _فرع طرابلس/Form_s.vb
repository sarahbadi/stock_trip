...
Public Class Form_s
    ...
    Sub total_inf_new()
        ...
        If (Me.TextBox8.Text.ToString) <> " " Then
            ...
            If Im_tadel = "جديد" And (sefa = "امين مخزن" Or sefa = "موظف") Then
                ...
                TextBox8.Text = getNewNo(Me.dtYear.Value.Year, "GetNewNoRcvMain")
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        End If
        Me.DataGridViewX2.Rows.Add(no_c, qun_r, sal_s, gema, txt_s, mt, date_end, mdh, mdh_a, date_mdh)
    ...
    Sub total_inf_tadel()
        ...
        If (Me.TextBox8.Text) <> " " Then
            ...
            sql1 = "SELECT no_c as[رقم الصنف],qun_r as[الكمية], sal_s as[سعر_الوحدة], gema as[القيمة], txt_s as[حاله_الاضافه],mt as[ملاحظات],date_end as [تاريخ_انتهاء_الصلاحية],mdh as [المدة_قبل_انتهاء_الصلاحية],mdh_a as [نوع_المدة],date_mdh as [تاريخ_التنبيه] from View_sl  WHERE no_i='" + TextBox8.Text + "'  ORDER BY no_ct1 "
    ...
    Private Sub Button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button4.Click
        ...
        Dim scn As String = "select * from Table_OSTA where no_R=@x1 and date_r=@x3 "
        Dim cmcn As New SqlCommand(scn, cn)
        cmcn.Parameters.Add(New SqlParameter("@x1", CStr(TextBox8.Text)))
        cmcn.Parameters.Add(New SqlParameter("@x3", CDate(TextBox15.Text)))
        ...
        If Me.TextBox1.Text <> "" Then
            ...
            Dim s As String = "select * from tran_IRT where no_c=@x1 and date_i=@x3 and (tr_type=3 or  tr_type=4 or  tr_type=5) and price=@x5"
            Dim cm As New SqlCommand(s, cn)
        ...
        Else
            ...
            Try
                ...
                cmr.ExecuteNonQuery()
                '======================================
                Dim srs As String = "update tran_IRT set date_i=@x2 where(tr_type=1 or  tr_type=2) and n_rs=@x1"
    ...
    Private Sub Button6_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button6.Click
        ...
        Dim scn As String = "select * from Table_OSTA where no_c=@x1 and no_R=@x2 and date_r=@x3 and sal_s=@x4"
        Dim cmcn As New SqlCommand(scn, cn)
    ...
    Private Sub Button5_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button5.Click
        ...
        Dim stb As String = "select * from Table_OSTA where no_R=@x1 and date_r=@x2"
